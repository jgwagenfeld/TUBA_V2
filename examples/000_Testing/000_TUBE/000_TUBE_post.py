...
file = tkFileDialog.askopenfilename(parent=root,
                                    initialdir='/home/jangeorg/TUBA/examples/000_Testing/000_TUBE',
...
try:
    ...
    Visualization_Geom = LegacyVTKReader(FileNames=['//home/jangeorg/TUBA/examples/000_Testing/000_TUBE/compound_paravis.vtk'])
