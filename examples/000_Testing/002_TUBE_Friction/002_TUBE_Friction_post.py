...
file = tkFileDialog.askopenfilename(parent=root,
                                    initialdir='/home/jangeorg/TUBA/examples/000_Testing/002_TUBE_Friction',
...
Stress = ELNOMesh(Input=new_casermed_0)        
...
try:
    ...
    Visualization_Geom = LegacyVTKReader(FileNames=['//home/jangeorg/TUBA/examples/000_Testing/002_TUBE_Friction/compound_paravis.vtk'])
