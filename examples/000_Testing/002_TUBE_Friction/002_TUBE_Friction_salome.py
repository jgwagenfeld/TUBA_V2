...
time1=time.time()
import sys
sys.path.append(' /home/jangeorg/TUBA/examples/000_Testing/002_TUBE_Friction ')
...
#    try:
#      Completed_Mesh.ExportMED( r'/home/jangeorg/TUBA/examples/000_Testing/002_TUBE_Friction/Completed_Mesh.mmed', 0)
#    except:
#      print ('ExportPartToMED() failed')


    try:    
        geompy.ExportVTK(compound_paravis, '/home/jangeorg/TUBA/examples/000_Testing/002_TUBE_Friction/compound_paravis.vtk', 0.001)     
    except:
