...
sys.path.append(' /home/jangeorg/TUBA/examples/000_Testing/004_BAR ')
...
#    commandList.append(('CircularBeam', {'R': 35.0, 'Group_Maille': 'V0', 'EP': 4.0}))    
    ...
    if List_Visualization!=[]:
       ...
       Pipe_V0.SetColor(SALOMEDS.Color(0.4,0.4,0.4))
...
#    commandList.append(('CircularBeam', {'R': 35.0, 'Group_Maille': 'V1', 'EP': 4.0}))    
    ...
    if List_Visualization!=[]:
       ...
       Pipe_V1.SetColor(SALOMEDS.Color(0.4,0.4,0.4))
...
#    commandList.append(('CircularBeam', {'R': 35.0, 'Group_Maille': 'V2', 'EP': 4.0}))    
    ...
    if List_Visualization!=[]:
       ...
       Pipe_V2.SetColor(SALOMEDS.Color(0.4,0.4,0.4))
...
#    try:
#      Completed_Mesh.ExportMED( r'/home/jangeorg/TUBA/examples/000_Testing/004_BAR/Completed_Mesh.mmed', 0)
#    except:
#      print ('ExportPartToMED() failed')


    try:    
        geompy.ExportVTK(compound_paravis, '/home/jangeorg/TUBA/examples/000_Testing/004_BAR/compound_paravis.vtk', 0.001)     
    except:
