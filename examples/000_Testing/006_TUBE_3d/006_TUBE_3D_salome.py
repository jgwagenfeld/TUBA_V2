...
time1=time.time()
import sys
sys.path.append(' /home/jangeorg/TUBA/examples/000_Testing/006_TUBE_3d ')
...
#    commandList.append(('CircularBeam', {'R': 35.0, 'Group_Maille': 'V2', 'EP': 4.0}))    
    ...
    if List_Visualization!=[]:
       ...
       Pipe_V_Bent3.SetColor(SALOMEDS.Color(0.6,0.6,0.6))
...
#    commandList.append(('CircularBeam', {'R': 35.0, 'Group_Maille': 'V6', 'EP': 4.0}))    
    ...
    if List_Visualization!=[]:
       ...
       Pipe_V6.SetColor(SALOMEDS.Color(0.6,0.6,0.6))
...
#    try:
#      Completed_Mesh.ExportMED( r'/home/jangeorg/TUBA/examples/000_Testing/006_TUBE_3d/Completed_Mesh.mmed', 0)
#    except:
#      print ('ExportPartToMED() failed')


    try:    
        geompy.ExportVTK(compound_paravis, '/home/jangeorg/TUBA/examples/000_Testing/006_TUBE_3d/compound_paravis.vtk', 0.001)     
    except:
