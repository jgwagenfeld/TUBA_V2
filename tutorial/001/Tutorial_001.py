...
#From the startpoint, a 1000mm(mmNS) long vector-object is created carrying all the above defined global properties.
V(1000,0,0)

#Creates 4 colinear vectors (colinear to the last created vector) and blocks the y and z direction of each vector-endpoint.
for i in range(0,4):
	Vc(1000)
	Block(y=0,z=0)
