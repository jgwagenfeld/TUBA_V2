...
sys.path.append(' /home/jangeorg/TUBA/tutorial/003_differentModels ')
...
def Project():
    ...
    Vd2x_P2 = geompy.MakeVectorDXDYDZ(6.123233995736766e-17, 6.123233995736766e-17, 1.0)
    ...
    Vd2x_P3 = geompy.MakeVectorDXDYDZ(6.123233995736766e-17, 6.123233995736766e-17, 1.0)
    ...
    P5_6_center_vd2x=    geompy.MakeTranslationVectorDistance(P5_6_center,Vd2x_P5_6_center,100)
    ...
    try:
       ...
       V_Bent4M.GroupOnFilter( SMESH.NODE,'P6', smesh.GetFilter( SMESH.NODE, SMESH.FT_LyingOnGeom,'=',P6))
    ...
    if not(ERREUR):
        Completed_Mesh = smesh.Concatenate([V0M.GetMesh() , V_Bent1M.GetMesh() , V2M.GetMesh() , 
           V3M.GetMesh() , V_Bent4M.GetMesh() , V5M.GetMesh() ,], 1, 0, 1e-05)
