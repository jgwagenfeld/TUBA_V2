...
#                                    initialdir='/media/sf_Shared_Folder_Linux/TUBA/tutorials/000_Testing/000_TUBE',
...
file="/media/sf_Shared_Folder_Linux/TUBA/tutorials/000_Testing/000_TUBE/000_TUBE-RESULTS_salome.rmed"
...
try:
    ...
    Visualization_Geom = LegacyVTKReader(FileNames=['//media/sf_Shared_Folder_Linux/TUBA/tutorials/000_Testing/000_TUBE/compound_paravis.vtk'])
