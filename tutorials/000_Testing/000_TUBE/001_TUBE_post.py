...
#                                    initialdir='/home/cae/TUBA_2019/tutorials/000_Testing/000_TUBE',
...
file="/home/cae/TUBA_2019/tutorials/000_Testing/000_TUBE/001_TUBE-RESULTS_salome.rmed"
...
Force_Vectors.ScaleArray = ['POINTS','RESU____FORC_NODA_Vector']                  
Force_Vectors.OrientationArray = ['POINTS','RESU____FORC_NODA_Vector'] 
...
TUBE = MEDReader(FileName=file)
RenameSource('TUBE',TUBE)

keys=TUBE.GetProperty("FieldsTreeInfo")[::2]
#Get all the fields contained in the ResultFile
arr_name_with_dis=[elt.split("/") for elt in keys]

for arr in arr_name_with_dis:
    if 'Flexibility' in arr[3]:
        comfield=arr[2]
        timestep=arr[0]
...
print(newlist)
TUBE.AllArrays = newlist
TUBE.GenerateVectors = 1
...
Stress = ELNOfieldToSurface(Input=TUBE)        
...
try:
    ...
    Visualization_Geom = LegacyVTKReader(FileNames=['//home/cae/TUBA_2019/tutorials/000_Testing/000_TUBE/compound_paravis.vtk'])
